...
function updateRigGallery(){
 const src='assets/rig/'+rigImages[currentRigIndex]
...
function updateProductGallery(){
 const src='assets/mattebox/'+currentColor.toLowerCase()+'/'+productImages[currentColor][currentProductIndex]
...
function preloadImages(){
 ...
 cache('assets/rig/'+rigImages[0])
 cache('assets/rig/'+rigImages[1])
 cache('assets/mattebox/obsidian/'+productImages['OBSIDIAN'][0])
 cache('assets/mattebox/obsidian/'+productImages['OBSIDIAN'][1])

 // Resto en idle
 requestIdleCallback(()=>{
  rigImages.forEach(f=>cache('assets/rig/'+f))
  Object.keys(productImages).forEach(color=>{
   productImages[color].forEach(f=>cache('assets/mattebox/'+color.toLowerCase()+'/'+f))
  })
 },{timeout:3000})
}
...
function updateTp1RigGallery(){
 const src='assets/TP1/tp1 rig/'+tp1RigImages[currentTp1RigIndex]
...
function updateTp1ProductGallery(){
 const src='assets/TP1/tp1 colores/'+tp1ProductImages[currentTp1ProductIndex]
